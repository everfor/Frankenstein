...
{
	setShadow(new Shadow(glm::ortho<float>(-half_shadow_area, half_shadow_area, -half_shadow_area, half_shadow_area, -half_shadow_area, half_shadow_area), 0.0002, 0.0, false));
}
