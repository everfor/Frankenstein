		...
		Game(core, enable_phys)
{
	...
	RigidBody *rigidBody1 = new RigidBody(glm::vec3(0.2, 0.0, -0.1), 1.0f, 0.9f, 0.4f, 0.4f);
	...
	RigidBody *rigidBody2 = new RigidBody(glm::vec3(-0.4, 0.0, 0.2), 10.0f, 1.0f, 0.4f, 0.4f);
